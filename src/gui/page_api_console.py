"""Interactive REST API Console & Explorer Page for NiceGUI."""
...
class ApiConsolePage:
    """Page allowing users to interactively test and explore REST endpoints."""
        ...
        with ui.column().classes(
            ...
            with (
                ...
                with ui.column().classes("gap-0"):
                    ui.label("REST API Console & Explorer").classes("text-h4")
                    ui.label(
                        "Interactive live endpoint debugger and REST response tester"
                    ).classes("text-xs text-gray-400")

            # Explorer Card (fills full page width & height)
            with ui.card().classes(
                ...
                with ui.row().classes("w-full gap-2 items-center shrink-0"):
                    ...
                    ui.button(
                        "Execute", icon="send", on_click=self._execute_request
                ...
                # Response Viewer (fills available height)
                with ui.element("div").classes(
